...
<body>
<button><a href="fee_history.php">Add Student payment record</a></button>
<button id="btn"><a href="payment-report.php">Payment Report</a></button>
