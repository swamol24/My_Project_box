...
// move_uploaded_file($tempname, $photo);
 ...
 $updateQuery="UPDATE staff SET fullname='$fullname',photo='$photo',department='$department',phone='$phone',age='$age',gender='$gender',salary='$salary' WHERE id=".$_GET["id"];
...
// print_r($row);
	...
	<div><label for="photo">Upload image :</label>
		<input type="file" name="photo" value="<?php echo $row['image']; ?>" id="fileToUpload" /></div>
	...
	<input type="text" name="salary" value="<?php echo $row['salary']; ?>" placeholder="Enter Salary.." />
