...
<body>
<button><a href="add_new_staff.php">Add New Staff Member</a></button>
...
<tr>
    ...
    <td id="edit_tab"><a href="update_staff_record.php?id=<?php echo $row["id"]; ?>">Edit/Update</a></td> 
    <td id="delete_tab" ><a href="delete_staff_record.php?id=<?php echo $row["id"]; ?>">Delete</a></td>      
 </tr>
 <?php 
  $i++; 
 } 
