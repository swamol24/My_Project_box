...
$marks = validation($marks);
 ...
 //student marks record update/edit through query

$updateQuery="UPDATE student SET fullname='$fullname',subject='$subject',marks='$marks' WHERE id=".$_GET['id'];
...
<body>
    ...
    $sql = "SELECT * FROM score_card WHERE id=".$_GET['id'];
