...
$logouttime = validation($logouttime);
 ...
 $query = "INSERT INTO staff_attendence (fullname,department,classdate,jointime,logouttime) VALUES ('$fullname','$department','$classdate','$jointime','$logouttime')";
 $result = mysqli_query($connect,$query);
 if($result){
 	echo "staff marked attendence successfully !!<br>";
 }
}
?>
<!DOCTYPE html>
